...
a = Analysis(['server.py'],
             pathex=['C:\\Users\\aakash.chotrani\\Desktop\\ServerExe'],
             binaries=face_models,
             datas=[],
             hiddenimports=['scipy._lib.messagestream', 'scipy', 'scipy.signal', 'scipy.signal.bsplines', 'scipy.special', 
							...
							'scipy.interpolate','scipy.io','scipy.linalg','scipy.misc','scipy.ndimage','scipy.odr','scipy.optimize',
